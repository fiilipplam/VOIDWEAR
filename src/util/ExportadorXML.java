...
public class ExportadorXML {
	...
	public static void exportar(Usuario gestor) {
		try {
			...
			// Log del evento
			LogDAO.insertar(new Log(java.time.LocalDateTime.now(), gestor.getCorreo(), "EXPORTACION",
					"Exportación de pedidos a XML completada"));
			JOptionPane.showMessageDialog(null, "Exportación completada correctamente.", "Éxito",
					JOptionPane.INFORMATION_MESSAGE);

		} catch (Exception e) {
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, "Error durante la exportación: " + e.getMessage(), "Error",
